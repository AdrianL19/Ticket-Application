...
import com.example.application.views.Administrator.WelcomeDriver;
...
@CssImport("./styles/views/main/driver-view.css")
public class MainViewDriver extends AppLayout {

    private final Tabs menu;
    private H1 viewTitle;


    public MainViewDriver() {
